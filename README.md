...
- Third-year CS student at **COMSATS University, Lahore**
- Building AI systems with a focus on **machine learning** and real-world problem solving
- Experienced in **full-stack development** (MERN) and **backend engineering** (FastAPI, Node.js)
- Working with databases including **PostgreSQL, Firebase, and Neo4j**
- **Operational Lead** at Google Developer Groups — organizing sessions for 2000+ students
- Presented at the **GDG APAC Solution Challenge 2025**
...
[![Frontend](https://skillicons.dev/icons?i=react,nextjs,nodejs,fastapi,bootstrap&theme=dark)](https://skillicons.dev)

**Databases & Tools**

[![Tools](https://skillicons.dev/icons?i=postgresql,firebase,docker,git,figma&theme=dark)](https://skillicons.dev)
...
Full-stack MERN e-commerce store with product listings, cart management, and user authentication.
...
**Bilingual Job Description Analyzer**

AI web app classifying English & Urdu job descriptions using mBERT + ANN with skill gap analysis and a React metrics dashboard.
...
Diagnostic prototype using Google Gemini API for intelligent Parkinson's disease detection. Presented at **GDG APAC Solution Challenge 2025**.
...
**Operational Lead**
Google Developer Groups (GDG) · *2025 – Present*

Organized technical sessions on AI and software development. Guided students on internships and project development.

</td>
<td width="50%" valign="top">

**Campus Ambassador**
Devsinc · *2025 – Present*

Led campus outreach engaging 2000+ students. Connected peers with industry professionals for internships and AI careers.
...
`Internships` &nbsp; `AI & ML Projects` &nbsp; `Software Engineering Roles` &nbsp; `Open Source Collaboration`
